...
namespace app
{
	...
	struct InteractiveCellManager__VTable {
		VirtualInvokeData Equals;
		VirtualInvokeData Finalize;
		VirtualInvokeData GetHashCode;
		VirtualInvokeData ToString;
	...
	struct InteractiveCellManager__Class {
		Il2CppClass_0 _0;
		Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
		struct InteractiveCellManager__StaticFields* static_fields;
		const Il2CppRGCTXData* rgctx_data;
		Il2CppClass_1 _1;
		struct InteractiveCellManager__VTable vtable;
	};

	struct InteractiveCellManager__Fields {
		struct MonoBehaviour__Fields _;
		struct ot* cjlw;
		struct CustomGridGenerator* m_gridGenerator;
		bool m_debug;
		struct Shader* m_flashGeometryShader;
		struct Color m_colorForDetailsCell;
		struct TextMeshPro* m_cellDetailsText;
		struct Transform* m_cellDetailsBlock;
		struct Transform* m_graphicCellsParent;
		struct eur* cjlx;
		struct eus* cjly;
		struct eue* cjlz;
		struct euu* cjma;
		...
		struct Vector3 cjmf;
		bool cjmg;
		struct GameObject* cjmh;
		int32_t cjmi;
		struct StringBuilder* cjmj;
		struct MapMetadata* cjmk;
		struct Mesh* cjml;
		struct List_1_UnityEngine_GameObject_* cjmm;
		struct Material* cjmn;
		struct gzs* cjmo;
		struct List_1_Core_Rendering_GraphicCell_* graphicCells;
		int32_t cjmp;
		struct Vector3 cjmq;
	};

	struct InteractiveCellManager {
		struct InteractiveCellManager__Class* klass;
		MonitorData* monitor;
		struct InteractiveCellManager__Fields fields;
	};

	struct InputChecker__VTable {
		VirtualInvokeData Equals;
		VirtualInvokeData Finalize;
		VirtualInvokeData GetHashCode;
		VirtualInvokeData ToString;
	...
	struct InputChecker__Class {
		Il2CppClass_0 _0;
		Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
		struct InputChecker__StaticFields* static_fields;
		const Il2CppRGCTXData* rgctx_data;
		Il2CppClass_1 _1;
		struct InputChecker__VTable vtable;
	};

	struct InputChecker__Fields {
		struct MonoBehaviour__Fields _;
		struct Action* cxyp;
		struct Vector3 cxyq;
	};
	...
	struct InputChecker {
		struct InputChecker__Class* klass;
		MonitorData* monitor;
